...
export default function Footer({ setPage }) {
  ...
  return (
    <footer className="footer">
      <div className="icons" id="home" onClick={home}>
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
      ...
      <div className="icons" id="message" onClick={messageTray}>
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
      ...
      <div className="icons" id="like" onClick={favorites}>
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
      ...
      <div className="icons" id="user" onClick={user}>
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
